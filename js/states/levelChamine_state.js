(function () {
    ...
    var LevelChamineState = function(LevelChamine) {
        // load sprites here
        this.player = gameManager.getSprite('player'); 
    };
    
    LevelChamineState.prototype.preload = function() {
        // Carregando o Player
        this.player.preload();
        ...
        // Sounds
        this.game.load.audio('environmentSoundLevelChamine', 'assets/sounds/levels/simonMathewson8bitEnergyDrinkComedown1.ogg');
    }

    LevelChamineState.prototype.create = function() {
        ...
        // Áudios
        gameManager.globals.environmentSoundLevelChamine = this.game.add.audio('environmentSoundLevelChamine');
        gameManager.globals.environmentSoundLevelChamine.lopp = true;
        gameManager.globals.environmentSoundLevelChamine.play();
        ...
        this.wallsLayer = this.LevelChamine.createLayer('Walls');
        this.wallsLayer.resizeWorld();
        
        //Tile maps - collision
        //this.LevelChamine.setCollisionByExclusion([19,20,21,22,23,24], true, this.wallsLayer);
        this.LevelChamine.setCollisionByExclusion([], true, this.wallsLayer);
        this.LevelChamine.setCollisionByExclusion([], true, this.fireLayer);
        ...
        this.LevelChamine.createFromObjects('Items', 'life', 'blood', 0, true, false, this.livesToCollect);
        this.livesToCollect.forEach(function(addlifeLevelChamine) {
            addlifeLevelChamine.anchor.setTo(0.5);
            addlifeLevelChamine.body.immovable = true;
        });
        
        // Capas Level 1
        this.capasToCollectLevelChamine = this.game.add.physicsGroup();
        this.LevelChamine.createFromObjects('Items', 'capa', 'capa_hud', 0, true, false, this.capasToCollectLevelChamine);
        this.capasToCollectLevelChamine.forEach(function(addCapaLevelChamine) {
            addCapaLevelChamine.anchor.setTo(0.5);
            addCapaLevelChamine.body.immovable = true;
        });
        
        //Ratos
        this.ratos = this.game.add.physicsGroup();
        this.LevelChamine.createFromObjects('Enemies', 'rato', 'rato', 8, true, false, this.ratos);
        ...
        this.LevelChamine.createFromObjects('Enemies', 'fireBullet', 'items', 5, true, false, this.fireBullets);
        ...
        this.LevelChamine.createFromObjects('Items', 'diamond', 'items', 5, true, false, this.diamonds);
        // Para cada objeto do grupo, vamos executar uma função
        ...
        this.LevelChamine.createFromObjects('Enemies', 'bat', 'enemies', 8, true, false, this.bats);
    ...
    LevelChamineState.prototype.update = function() {
        ...
        // Player pegando capa
        this.game.physics.arcade.overlap(this.player.sprite, this.capasToCollectLevelChamine, this.player.capasToCollectCollision, null, this.player); 
    ...
    LevelChamineState.prototype.playerBulletCollision = function(ratos, bullet) { //Bala do player colidindo com o inimigos "RATO"
        bullet.kill();
        ratos.kill();
        this.player.increaseScoreRatos.apply(this.player);
    }

    LevelChamineState.prototype.diamondCollect = function(player, diamond){ //Jogando Colidindo com o Diamante e indo para o Level 2
        diamond.kill();
    ...
    LevelChamineState.prototype.fireBulletCollideWall = function(fireBullet){
        fireBullet.kill();
    }
    ...
    LevelChamineState.prototype.fireDeath = function(player, fire){
        this.player.decreaseLives.apply(this.player);
    }

    gameManager.addState('levelChamine', LevelChamineState);
